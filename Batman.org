...
**** BLOCK Superman: Secret Identity 秘密身份 :P2004:
**** NOW Up, Up, and Away 一飞冲天 :P2006:
SCHEDULED: <2022-10-07 Fri>

**** BLOCK Superman: Secret Origin 秘密起源 :P2009:
**** BLOCK Superman: Earth One 一号地球 :P2010:
...
*** greatest hits
**** BLOCK Superman: For All Seasons 四季 :P1998:
**** Superman: Red Son :P2003:
**** DONE All-star Superman :P2005:Grant_Morrison:
**** Superman: Kryptonite :P2006:
**** Superman, by Kurt Busiek :P2006:
**** Action Comics, by Geoff Johns :P2006:
**** Superman: Action Comics, by Grant Morrison :P2011:
**** Superman: Up in the Sky :P2018:
**** Action Comics, by Phillip Kennedy Johnson :P2021:
*** Kingdom Come
