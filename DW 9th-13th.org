...
***** READY [#A] 3.3 Monsters in Metropolis :Cybermen:plot_yes:bilibili:D2022_05_doctor:
:PROPERTIES:
:rating:   8.8
:END:
...
**** vol.4 Old Friends
***** HALF [#C] 4.1 Fond Farewell :bilibili:
:PROPERTIES:
:rating:   7.6
:END:
...
**** [#D] 1.3 - The Light Keepers :plot_yes:D2022_05_doctor:
:PROPERTIES:
:rating:   7.1
:END:
