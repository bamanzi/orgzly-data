...
**** series 8 (61-72)
***** HALF [#C] 61. War Chest :Tosh:P2022_05:DW2023_04_spinoffs:
...
**** [#B] special 2: Outbreak :P2016:3CD:plot_yes:
     :PROPERTIES:
     :rating:   8.3
     :END:
...
***** [#A] 3 - Peach Blossom Heights :DW2023_06_spinoffs:
      :PROPERTIES:
      :rating:   9.2
      :END:
...
***** 2DONE [#A] 1.4 The Spread :DW2023_04_spinoffs:
      CLOSED: [2023-04-11 Tue 08:29] SCHEDULED: <2023-04-09 Sun>

***** DONE [#A] 1.5 The Dead Hand [#S] :DW2023_04_spinoffs:
      CLOSED: [2023-04-21 Fri 09:00] DEADLINE: <2023-04-23 Sun>

***** 3QTR [#A] 1.6 The Liberty of Norton Folgate :DW2023_04_spinoffs:
...
*** START [#D] 7.2 The Night of 1000 Stars           (7.2) :Leela:plot_no:DW2023_06_spinoffs:
...
*** Series 10 :P2009:
*** Series 11 :P2010:
**** HALF [#A] 11.3 - Year Zero :DW2023_05_maybe:
     SCHEDULED: <2023-05-21 Sun>

**** [#C] 11.4 - Dead Man's Switch
** Bernice Summerfield (boxset)
*** Boxset 1: Epoch :P2011:Atlantis:plot_yes:
**** [#B] 1.1 The Kraken's Lament :Jack_McSpringheel:DW2023_05_spinoffs:
     SCHEDULED: <2023-06-01 Thu>
     :PROPERTIES:
     :rating:   7.9
     :END:

**** [#B] 1.2 The Temple of Questions :Ruth_Leonidas:DW2023_06_spinoffs:
     :PROPERTIES:
     :rating:   8.0
     :END:

**** [#C] 1.3 Private Enemy No. 1 :Ruth_Leonidas:DW2023_06_spinoffs:
     :PROPERTIES:
     :rating:   7.8
     :END:
...
*** TODO [#A] ST8.10 - I Am The Master †9.0 :Master:bilibili:DW2023_06_spinoffs:
...
*** LATER KC4. Taren Capel :DW2023_06_spinoffs:
*** KC5. Checkmate
*** KC6. Storm Mine
...
**** [#D] 1.2 - Hounded                     (7.2)
**** TODO [#C] 1.3 - Living History              (7.9) :11th_Dr:plot_yes:DW2023_05_spinoffs:
     SCHEDULED: <2023-05-28 Sun>
...
*** 3QTR [#C] Mind Games :Jago:Litefoot:Ellie:Quick:DW2023_05_spinoffs:
    CLOSED: [2023-05-09 Tue 21:52] SCHEDULED: <2023-05-07 Sun>

*** [#D] The Reesinger Process :Gilmore:Rachel:Allison:Toby:DW2023_06_spinoffs:
    :PROPERTIES:
    :rating:   7.2
    :END:
...
**** 3QTR [#D] 1.3 Inside Every Warrior :Vastra:Jenny:Strax:TPG:DW2023_04_spinoffs:
