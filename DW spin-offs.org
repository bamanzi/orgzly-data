...
***** [#A] TW43. The Three Monkeys :Owen:Andy:DW2023_08_spinoffs:
      :PROPERTIES:
      :rating:   8.8
      :END:
...
***** [#A] John1.3 - Peach Blossom Heights :Jack:DW2023_06_spinoffs:
...
***** BLOCK [#E] TWO2.1 - The Law Machines :DW2023_06_spinoffs:
      SCHEDULED: <2023-06-25 Sun>

超级电脑 WOTAN 最早出现于老版3x10 The War Machines 

***** [#C] TWO2.2 - Blind Summit :DW2023_07_spinoffs:
      :PROPERTIES:
      :rating:   7.7
      :END:
...
**** 3QTR [#A] BS11.3 - Year Zero :DW2023_05_spinoffs:
     CLOSED: <2023-05-12 Fri 08:16> SCHEDULED: <2023-05-14 Sun>

**** [#C] BS11.4 - Dead Man's Switch :DW2023_06_spinoffs:
...
*** [#C] UNIT1.1 - Vanguard (7.5) :DW2023_08_spinoffs:
    :PROPERTIES:
    :rating:   7.5
    :END:
...
** Sarah Jane Smith
*** [#E] SJS1.1 - Comeback (6.8) :DW2023_06_spinoffs:
...
**** [#D] CY1.2 - Hounded   (7.2) :DW2023_06_spinoffs:
     SCHEDULED: <2023-06-18 Sun>

**** TODO [#C] CY1.3 - Living History              (7.9) :Daleks:11th_Dr:plot_yes:DW2023_07_spinoffs:
...
*** [#D] WoDW#2 The Reesinger Process :Gilmore:Rachel:Allison:Toby:DW2023_06_spinoffs:
    SCHEDULED: <2023-06-11 Sun>
    :PROPERTIES:
    :rating:   7.2
    :END:
