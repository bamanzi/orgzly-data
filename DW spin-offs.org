...
***** START [#A] 21. We Always Get Out Alive [#S] :Gwen:Rhys:DW2022_09_maybe:
...
***** [#A] 43. The Three Monkeys :Owen:Andy:DW2022_11_spinoffs:
      :PROPERTIES:
      :rating:   8.8
      :END:
...
***** [#A] 54. Curios (8.9) :Bilis_Manger:DW2022_11_spinoffs:
      :PROPERTIES:
      :rating:   8.9
      :END:
...
**** series 8 (61-72)
***** TODO [#C] 61. War Chest :Tosh:DW2022_09_maybe:
      SCHEDULED: <2022-09-30 Fri>

***** 62. Dead Plates :Bilis_Manger:
***** 63. Restricted Items Archive Entries 031–049
***** 64. Suckers :Tosh:
*** specials
...
***** HALF [#A] 6.6 Hostile Environment (9.0) :Tyler:DW2022_09_spinoffs:
      SCHEDULED: <2022-09-11 Sun>

***** TODO [#A] 6.7 Another Man's Shoes (8.8) :Norton:P2019:DW2022_10_spinoffs:
      SCHEDULED: <2022-10-29 Sat>

***** TODO [#A] 6.8 Eye of the Storm (8.8) :Norton:P2019:DW2022_10_spinoffs:
      SCHEDULED: <2022-10-29 Sat>
...
**** START [#C] 6.4 The Talents of Greel        (7.8) :Jago:DW2022_09_maybe:
     SCHEDULED: <2022-09-30 Fri>

*** DoRS 7 :P2020:
**** TODO [#C] 7.1 Colony of Strangers         (7.7) :DW2022_10_spinoffs:
     SCHEDULED: <2022-10-29 Sat>
...
*** TODO [#C] 3.3 - Appropriation (7.9) :DW2022_09_maybe:
    SCHEDULED: <2022-09-30 Fri>

*** [#A] 3.4 - Mindbomb (8.9) :DW2022_10_spinoffs:
...
*** [#A] 4.2 - Disassembled (9.1) :DW2022_10_spinoffs:
*** [#B] 4.3 - Annihilation (8.0) :DW2022_11_spinoffs:
*** [#C] 4.4 - Forever      (7.9)
** series 5 :P2013:
...
**** 2DONE [#A] 5.1 The Grel Escape :DW2022_08_spinoffs:plot_dwg:
...
**** START [#D] 1.2 Prey :DW2022_10_spinoffs:
     SCHEDULED: <2022-10-29 Sat>
     :PROPERTIES:
     :rating:   7.4
     :END:

**** TODO [#A] 1.3. Vengeance :DW2022_10_spinoffs:
     SCHEDULED: <2022-10-29 Sat>
     :PROPERTIES:
     :rating:   8.6
     :END:
...
*** TODO [#C] 6.3 - Code Silver      (7.8) :Cybermen:plot_yes:DW2022_09_spinoffs:
    SCHEDULED: <2022-09-21 Wed>

*** TODO [#B] 6.4 - Master of Worlds                 (8.4) :Cybermen:Master_War:DW2022_09_spinoffs:
    SCHEDULED: <2022-09-24 Sat>
...
*** HALF [#B] 2. Death's Head :DW2022_08_spinoffs:plot_dwg:
    SCHEDULED: <2022-09-04 Sun>

*** 3. Hidden Persuaders :DW2022_10_spinoffs:
...
**** TODO [#B] 2.1 - The Robots of War :plot_yes:DW2022_09_spinoffs:
     SCHEDULED: <2022-09-24 Sat>
     :PROPERTIES:
     :rating:   8.0
     :END:
...
*** PG: Heritage 2 :P2019:
**** TODO [#D] 2.1 - Dining with Death         (7.0) :DW2022_09_spinoffs:
     SCHEDULED: <2022-09-29 Thu>

**** [#C] 2.2 - The Screaming Ceiling     (7.6) :DW2022_11_spinoffs:
...
*** TODO [#C] 1.3 - The Pelage Project           (7.7) :DW2022_10_spinoffs:
    SCHEDULED: <2022-10-29 Sat>

*** [#B] 1.4 - State of Emergency           (8.3) :DW2022_11_spinoffs:
** CM series 2 :P2013:
*** [#B] 2.1 - Manhunt                      (8.1)
...
**** [#D] 1.2 - Hounded                     (7.2)
**** TODO [#C] 1.3 - Living History              (7.9) :11th_Dr:plot_yes:DW2022_09_maybe:
     SCHEDULED: <2022-09-30 Fri>
...
**** TODO [#C] 1.1 - It Takes a Thief (7.8) :DW2022_10_maybe:
     SCHEDULED: <2022-10-29 Sat>
...
*** TODO [#B] 1. Out of this World (8.1) :bilibili:DW2022_10_spinoffs:
    SCHEDULED: <2022-10-29 Sat>

【【神秘博士广播剧熟肉】Kidnapped! 101 Out of this World 世界之外-哔哩哔哩】 https://b23.tv/By95ZJG

*** [#C] 2. Spinvasion (7.8) :DW2022_11_spinoffs:bilibili:
...
**** HALF [#A] 1.3 - I, Rorius              (8.7) :DW2022_09_spinoffs:
     SCHEDULED: <2022-09-18 Sun>
