...
***** [#A] 43. The Three Monkeys :Owen:Andy:DW2023_06_spinoffs:
      :PROPERTIES:
      :rating:   8.8
      :END:
...
***** [#A] 51. The Five People You Kill in Middlebrough (8.5) :Yvonne:plot_yes:DW2023_04_maybe:
...
***** [#C] 56. The Red List (7.8) :Ace:Colchester:DW2023_05_spinoffs:
***** [#A] 57. The Grey Mare (8.5) :Ianto:
***** [#B] 58. Cadoc Point (8.4) :Andy:
***** [#A] 59. Sonny (8.9) :Rhys:
***** CANCEL [#E] 60. Infidel Places+ (6.7) :Queen:
**** series 8 (61-72)
***** TODO [#C] 61. War Chest :Tosh:P2022_05:DW2023_04_spinoffs:
...
**** [#A] Torchwood Soho: Parasite :3CD:P2020:plot_yes:Norton:Andy:

https://tardis.fandom.com/wiki/Parasite_(audio_story)

***** 3QTR [#B] Parasite #1-2 :DW2023_03_spinoffs:
      CLOSED: [2023-03-24 Fri 08:26] SCHEDULED: <2023-03-05 Sun>

***** [#A] Parasite #3-4 :DW2023_04_spinoffs:
      SCHEDULED: <2023-04-30 Sun>

***** [#A] Parasite #5-6 :DW2023_05_spinoffs:
...
**** Torchwood Soho #3 The Unbegotten :P2022_10:
*** tv continuation :🎧:1CD:
**** Aliens Among Us
...
*** START [#D] 7.2 The Night of 1000 Stars           (7.2) :Leela:plot_no:DW2023_05_spinoffs:
*** HALF [#A] 7.3 Murder at Moorsey Manor           (8.7) :DW2023_01_spinoffs:
    SCHEDULED: <2023-01-09 Mon 21:33>

*** HALF [#C] 7.4 The Wax Princess                  (7.5) :plot_cast:DW2023_03_spinoffs:
...
*** HALF [#E] 5.1 - Emancipation (6.9) :DW2023_02_spinoffs:
    SCHEDULED: <2023-02-15 Wed 08:48>

*** HALF [#E] 5.2 - Evolution (6.5) :DW2023_03_spinoffs:
    SCHEDULED: <2023-03-05 Sun>

*** [#D] 5.3 - Arbitration (7.2) :Daleks:DW2023_04_spinoffs:
...
*** [#D] 2.3 - Treason and Plot :plot_cast:DW2023_05_spinoffs:
    SCHEDULED: <2023-05-28 Sun>
    :PROPERTIES:
    :rating:   7.2
    :END:

*** [#B] 2.4 - Too Many Masters :Monk:DW2023_04_maybe:
    SCHEDULED: <2023-05-01 Mon>
    :PROPERTIES:
    :rating:   8.2
    :END:
...
*** TODO [#A] ST8.10 I Am The Master :DW2023_04_spinoffs:
    SCHEDULED: <2023-04-30 Sun>

*** The Switching
*** Terror of the Master :audiobook:
...
*** [#C] 1.1 Vanguard (7.5) :DW2023_05_spinoffs:
    :PROPERTIES:
    :rating:   7.5
    :END:
...
*** [#C] 1.2 Fire and Ice :Ice_Warriors:
...
*** PG: Heritage 3 :P2020:
**** [#C] 3.1 - Family Matters            (7.5) :DW2023_04_maybe:
     SCHEDULED: <2023-04-30 Sun>
...
** The Churchil Years
*** series 1 :P2016:
**** CANCEL [#E] 1.1 - The Oncoming Storm          (6.9)
**** [#D] 1.2 - Hounded                     (7.2)
...
**** [#D] 1.2 - Skin Deep (7.2) :DW2023_03_spinoffs:
     SCHEDULED: <2023-03-26 Sun>

**** [#D] 1.3 - Portrait of a Lady (7.0) :Sontarans:DW2023_04_spinoffs:
     SCHEDULED: <2023-04-30 Sun>

**** [#C] 1.4 - Death on the Mile (7.7) :DW2023_05_spinoffs:
*** series 2 :P2021:
**** [#D] 2.1 - The Wreck (7.2?)
**** [#D] 2.2 - Walkabout (7.0?)
**** [#D] 2.3 - Long Shot (7.0?)
...
*** [#C] Mind Games :Jago:Litefoot:Ellie:Quick:
*** [#D] The Reesinger Process :Gilmore:Rachel:Allison:Toby:
*** [#B] The Screaming Skull :Ruth:Charlie_Sato:Yates:Jago:Litefoot:
*** [#D] Second Sight :6th_Dr:Romana_2:Leela:Yates:
...
**** [#D] 3.1 The House That Hoxx Built :3rd_Dr:Sarah:
...
**** TODO [#D] 1.3 Inside Every Warrior :Vastra:Jenny:Strax:TPG:DW2023_04_spinoffs:
     SCHEDULED: <2023-04-30 Sun>
