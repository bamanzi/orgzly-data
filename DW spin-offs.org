...
***** [#D] 47. Drive :Tosh:DW2022_11_maybe:
      :PROPERTIES:
      :rating:   7.3
      :END:
...
**** START [#C] 6.4 The Talents of Greel        (7.8) :Jago:DW2022_10_maybe:
     SCHEDULED: <2022-10-30 Sun>

*** DoRS 7 :P2020:
**** TODO [#C] 7.1 Colony of Strangers         (7.7)
**** [#D] 7.2 Abbey of Heretics           (7.2) :DW2022_12_spinoffs:
...
*** TODO [#D] 7.2 The Night of 1000 Stars           (7.2) :plot_no:DW2022_10_maybe:
    SCHEDULED: <2022-10-30 Sun>

*** [#A] 7.3 Murder at Moorsey Manor           (8.7) :DW2022_12_spinoffs:
...
*** TODO [#A] 4.2 - Disassembled (9.1) :plot_yes:DW2022_10_spinoffs:
...
**** [#B] 5.3 Dead and Breakfast :DW2022_11_doctor:
     :PROPERTIES:
     :rating:   8.2
     :END:
...
*** [#D] 2.3 - Treason and Plot :DW2022_12_spinoffs:
    :PROPERTIES:
    :rating:   7.2
    :END:
...
*** TODO KC3. Hidden Persuaders :DW2022_10_spinoffs:
...
*** TODO [#B] 1. Out of this World (8.1) :plot_no:bilibili:DW2022_10_spinoffs:
    SCHEDULED: <2022-10-16 Sun>
