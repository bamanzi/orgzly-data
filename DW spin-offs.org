...
***** START [#C] 1 - The Restored :DW2022_08_spinoffs:plot_none:
...
***** HALF [#C] 6.5 Flight 405 (7.8) :Norton:P2019:DW2022_08_spinoffs:
      SCHEDULED: <2022-08-06 Sat>

***** TODO [#A] 6.6 Hostile Environment (9.0) :DW2022_09_spinoffs:
***** [#A] 6.7 Another Man's Shoes (8.8) :Norton:P2019:DW2022_09_spinoffs:
***** [#A] 6.8 Eye of the Storm (8.8) :Norton:P2019:DW2022_09_spinoffs:
***** [#B] 6.9 A Mother's Son (8.2)
***** [#B] 6.10 ScrapeJane (8.2)
***** [#A] 6.11 Day Zero (8.7)
...
**** START [#C] 6.4 The Talents of Greel        (7.8) :Jago:DW2022_09_spinoffs:
     SCHEDULED: <2022-09-07 Wed>

*** DoRS 7 :P2020:
**** [#C] 7.1 Colony of Strangers         (7.7) :DW2022_09_spinoffs:
...
** J&L series 7 :P2014:
*** TODO [#B] 7.1 The Monstrous Menagerie           (8.1) :DW2022_08_spinoffs:
...
*** [#C] 3.3 - Appropriation (7.9) :DW2022_09_spinoffs:
*** [#A] 3.4 - Mindbomb (8.9)
*** [#B] 3.5 - Panacea (8.1)
** series 4 :P2011:
*** [#B] 4.1 - Reborn       (8.0)
*** [#A] 4.2 - Disassembled (9.1)
*** [#B] 4.3 - Annihilation (8.0)
*** [#C] 4.4 - Forever      (7.9)
** series 5 :P2013:
...
**** 3QTR [#A] 5.1 The Grel Escape :DW2022_08_spinoffs:plot_dwg:
...
**** READY [#B] 5.3 The Relics of Jegg-Sau :DW2022_09_spinoffs:
     :PROPERTIES:
     :rating:   8.1
     :END:
...
**** HALF [#A] BS6.5 The Crystal of Cantus :Cybermen:D2022_03_spinoffs:plot_dwg:
     SCHEDULED: <2022-03-19 Sat>
     :PROPERTIES:
     :rating:   8.7
     :END:
...
**** [#B] 1.1 The Kraken's Lament :Jack_McSpringheel:DW2022_09_spinoffs:
     :PROPERTIES:
     :rating:   7.9
     :END:

**** [#B] 1.2 The Temple of Questions :Ruth_Leonidas:DW2022_09_spinoffs:
     :PROPERTIES:
     :rating:   8.0
     :END:
...
**** TODO [#C] 5.1 Pride of the Lampian :DW2022_09_extra:
     :PROPERTIES:
     :rating:   7.9
     :END:
...
*** HALF [#D] 2.2 - Brimstone and Terror :plot_no:DW2022_08_spinoffs:
...
**** TODO [#D] 1.2 Prey :DW2022_09_spinoffs:
     :PROPERTIES:
     :rating:   7.4
     :END:

**** TODO [#A] 1.3. Vengeance :DW2022_09_spinoffs:
     :PROPERTIES:
     :rating:   8.6
     :END:
...
**** [#B] MR103 The Girl Who Never Was :8th_Dr:Charley:DW2022_10_doctor:
     :PROPERTIES:
     :rating:   8.4
     :END:
...
*** [#E] 6.2 - Telepresence   (7.0) :plot_no:DW2022_08_extra:
...
*** TODO 2. Death's Head :DW2022_08_spinoffs:
    SCHEDULED: <2022-08-28 Sun>
...
**** [#B] 2.1 - The Robots of War :DW2022_09_spinoffs:
     :PROPERTIES:
     :rating:   8.0
     :END:
...
*** PG: Heritage 2 :P2019:
**** [#D] 2.1 - Dining with Death         (7.0) :DW2022_09_spinoffs:
...
*** HALF [#C] 1.2 - Artificial Intelligence      (7.5) :DW2022_08_spinoffs:
    SCHEDULED: <2022-08-25 Thu>

*** [#C] 1.3 - The Pelage Project           (7.7) :DW2022_09_spinoffs:
*** [#B] 1.4 - State of Emergency           (8.3) :DW2022_10_spinoffs:
** CM series 2 :P2013:
*** [#B] 2.1 - Manhunt                      (8.1)
...
**** [#D] 1.2 - Hounded                     (7.2)
**** TODO [#C] 1.3 - Living History              (7.9) :11th_Dr:plot_yes:DW2022_09_spinoffs:
...
**** TODO [#C] 1.1 - It Takes a Thief (7.8) :DW2022_09_spinoffs:
**** [#D] 1.2 - Skin Deep (7.2)
...
**** HALF [#D] 1.4 - The Last Party on Earth (7.3) :DW2022_08_spinoffs:
...
**** TODO [#A] 1.3 - I, Rorius              (8.7) :DW2022_09_spinoffs:
*** vol.2 :P2022_03:
