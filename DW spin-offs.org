...
***** READY [#A] TW22. Goodbye Piccadilly :Andy:Norton:plot_yes:
      :PROPERTIES:
      :rating:   8.6
      :END:
...
***** HALF [#B] 48. Lease of Life :Owen:D2022_05_spinoffs:
...
***** READY [#A] 51. The Five People You Kill in Middlebrough :Yvonne:plot_yes:
      :PROPERTIES:
      :rating:   8.5
      :END:
...
***** 6.5 Flight 405 :D2022_08_spinoffs:
***** 6.6 Hostile Environment :D2022_08_spinoffs:
***** 6.7 Another Man's Shoes
***** 6.8 Eye of the Storm
...
***** HALF [#B] 1.1 New Girl :D2022_06_spinoffs:
      SCHEDULED: <2022-06-04 Sat>
      :PROPERTIES:
      :rating:   8.2
      :END:

***** [#E] 1.2 - Through The Ruins :D2022_06_spinoffs:
      SCHEDULED: <2022-06-18 Sat>

***** [#E] 1.3 - Uprising :D2022_07_spinoffs:
...
**** [#D] 6.2 The Web of Time             (7.0) :great_intelligence:D2022_06_extra:
...
*** [#C] 6.4 - The Trial of George Litefoot    (7.8) :D2022_06_spinoffs:
    SCHEDULED: <2022-06-18 Sat>
...
** series 3 :P2006:
*** [#B] 3.1 - Fractures (8.0) :D2022_08_spinoffs:
*** [#B] 3.2 - Warfare (8.3) :D2022_08_spinoffs:
...
**** [#B] 1.1 The Kraken's Lament :Jack_McSpringheel:D2022_07_spinoffs:
     :PROPERTIES:
     :rating:   7.9
     :END:

**** [#B] 1.2 The Temple of Questions :Ruth_Leonidas:D2022_07_spinoffs:
     :PROPERTIES:
     :rating:   8.0
     :END:

**** [#C] 1.3 Private Enemy No. 1 :Ruth_Leonidas:D2022_07_spinoffs:
     :PROPERTIES:
     :rating:   7.8
     :END:

**** [#B] 1.4 Judgement Day :Jack_McSpringheel:Ruth_Leonidas:D2022_07_spinoffs:
     :PROPERTIES:
     :rating:   8.3
     :END:
...
** Kaldor City
*** START [#B] KC1. Occam's Razor :D2022_06_spinoffs:
...
**** [#A] 1.3 - Love Me Not :D2022_07_spinoffs:
     :PROPERTIES:
     :rating:   8.8
     :END:
...
*** [#A] NCM0.1 - Who Killed Toby Kinsella? (8.5) :D2022_09_spinoffs:
*** [#B] NCM0.2 - The Dead Don't Rise (8.4) :D2022_09_spinoffs:
...
**** [#D] 1.2 - Hounded                     (7.2)
**** TODO [#C] 1.3 - Living History              (7.9) :11th_Dr:
...
**** [#E] +2.2 - Altered Status+ (6.8?) :Cybermen:D2022_06_spinoffs:
     SCHEDULED: <2022-06-18 Sat>

**** [#E] +2.3 - Calamity Jenny+ (6.6)
**** [#D] 2.4 - Her Own Wrost Enemy (7.0)
** Rose Tyler - The Dimension Cannon :P2019:Rose:
*** HALF [#B] 1.1 - The Endless Night       (8.3) :D2022_06_spinoffs:
    SCHEDULED: <2022-06-04 Sat>

*** [#C] 1.2 - The Flood               (7.6) :D2022_06_spinoffs:
    SCHEDULED: <2022-06-25 Sat>

*** [#C] 1.3 - Ghost Machines          (7.5) :D2022_08_spinoffs:
*** [#D] 1.4 - The Last Party on Earth (7.3) :D2022_08_spinoffs:
** Donna Nobel - Kidnapped :P2020:
*** [#B] 1. Out of this World (8.1) :D2022_07_spinoffs:
*** [#C] 2. Spinvasion (7.8)
*** [#E] +3. The Sorcerer of Albion+ (6.9)
*** [#C] 4. The Chiswick Cuckoos (7.9) :10th_Dr:
** The Lone Centurion
*** vol.1 :P2021:
**** [#C] 1.1 - Gladiator :D2022_07_spinoffs:
     :PROPERTIES:
     :rating:   7.9
     :END:

**** [#C] 1.2 - The Unwilling Assassin (7.7) :D2022_08_spinoffs:
**** [#B] 1.3 - I, Rorius              (8.7) :D2022_09_spinoffs:
*** vol.2 :P2022_03:
