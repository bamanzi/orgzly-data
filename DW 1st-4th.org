...
*** EA
**** EA S1
***** READY [#C] EA1.1 Domain of the Voord :plot_yes:
...
***** READY [#C] EA1.4 - An Ordinary Life :plot_yes:
**** EA S3
...
**** EA S5
***** READY [#A] EA5.1 The Dalek Occupation of Winter (9.0) :daleks:plot_yes:
...
***** READY EA7.2 The Secrets of Det-Sun :plot_yes:
*** 1DA
...
**** [#C] 3.1 The Phoenicians (7.5) :Susan:Ian:Barbara:plot_no:P2019:
**** READY [#A] 1DA3.2 Tick-Tock World :Susan:Ian:Barbara:P2019:plot_yes:D2022_03_doctor:
:PROPERTIES:
:rating:   8.5
:END:
...
*** EA
**** EA S2
***** READY [#C] 2.1 The Yes Men :Jamie:Polly:Ben:plot_yes:
:PROPERTIES:
:rating:   7.7
:END:
...
***** CANCEL [#E] 2.4 The Isos Network
**** EA S4
***** READY [#C] 4.1 The Night Witches :plot_yes:
:PROPERTIES:
:rating:   7.6
:END:

***** READY [#C] 4.2 The Outliers :plot_yes:
:PROPERTIES:
:rating:   7.7
:END:

***** CANCEL [#E] +4.3 The Morton Legacy+
:PROPERTIES:
:rating:   6.7
:END:
...
**** READY [#C] 2.2 The Hidden Realm :plot_yes:D2022_Q2_doctor:
:PROPERTIES:
:rating:   7.5
:END:
...
**** 3QTR [#C] 3DA 4.2 - The Tyrants of Logic :P2018:cybermen:plot_yes:D2022_02_doctor:
...
**** [#A] 7.1 The Unzal Incursion :P2021:Liz:
**** [#C] 7.2 The Gulf :P2021:Sarah:
...
**** [#B] CC8.4 - Ghost in the Machine :D2022_03_doctor:
:PROPERTIES:
:rating:   8.1
:END:
...
***** TODO [#C] 4.5 - Suburban Hell (7.7) :plot_yes:
...
***** TODO [#C] 8.3 - The Enchantress of Numbers (7.6)
