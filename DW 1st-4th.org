...
*** EA :2CD:EA:
**** EA S1
***** NEXT [#C] EA1.1 Domain of the Voord :Susan:Ian:Barbara:Voord:plot_yes:

应该先看老版剧集 1x05 The Keys of Marinus

***** NEXT [#D] EA1.2 The Doctor's Tale :Ian:Barbara:Vicki:plot_yes:
:PROPERTIES:
:rating:   7.1
:END:
...
**** NEXT [#B] 4.2 Last of the Romanovs :P2020:plot_yes:
:PROPERTIES:
:rating:   8.1
:END:
...
***** NEXT [#C] 22.2 The Miniaturist :Dodo:P2022_04:1CD:
...
***** TODO [#C] CC5.8 - The Perpetual Bond :Oliver:
...
***** Old Steven trilogy
****** START [#B] 8.10 The War to End All Wars :D2022_02_doctor:
...
***** [#B] 7.10 - The Library of Alexandria :plot_yes:
:PROPERTIES:
:rating:   8.0
:END:

**** 📂CC9. First Doctor - Volume One :P2015:
***** [#D] 9.1 - The Sleeping Blood :Barbaba:Ian:Vicki:
***** [#B] 9.2 - The Unwinding World :Vicki:Ian:Barbara:
:PROPERTIES:
:rating:   8.0
:END:

***** [#D] 9.3 The Founding Fathers :Steven:
...
***** NEXT [#A] 11.2 Across the Darkened City :Steven:Vicki:Daleks:
***** [#D] 11.3 The Bonfires of the Vanties :Polly:Ben:
***** 3QTR [#B] CC11.4 The Plague of Dreams :Polly:Ben:DW2023_05_doctor:
...
***** [#D] 13.4 - The Crumbling Magician :Ben:Polly:
*** Lost Stories
...
**** HALF [#C] LS2.1b The Fragile Yellow Arc of Fragrance :1CD:plot_yes:DW2023_09_doctor:
*** short trips
...
***** NEXT [#D] 2.2 The Forsaken :Jamie:Polly:Ben:plot_yes:
***** HALF [#B] 2.3 The Black Hole (8.1) :Jamie:Victoria:D2021_06:Monk:
***** CANCEL [#E] 2.4 The Isos Network :Jamie:Zoe:Cybermen:plot_yes:
**** EA S4
***** NEXT [#C] 4.1 The Night Witches :Jamie:Polly:Ben:plot_yes:
SCHEDULED: <2023-03-01 Wed>
:PROPERTIES:
:rating:   7.6
:END:

***** NEXT [#C] 4.2 The Outliers :Jamie:Polly:Ben:plot_yes:
:PROPERTIES:
:rating:   7.7
:END:
...
***** HALF [#C] 2DA22.2 Wrath of the Ice Warriors :Brigadier:ice_warriors:2CD:DW2023_08_doctor:
...
**** NEXT [#C] 5.9 - The Forbidden Time :Polly:plot_yes:
:PROPERTIES:
:rating:   7.5
:END:
...
**** [#C] 7.8 - The British Invasion :Zoe:Jamie:
:PROPERTIES:
:rating:   7.5
:END:
...
**** NEXT [#B] 8.2 The Devil's Hoofprints :P2021:Sarah:plot_yes:
:PROPERTIES:
:rating:   8.1
:END:
...
***** READY [#C] 4DA4.2 The Darkness of Glass (7.5) :plot_yes:DW2023_08_doctor:
...
***** NEXT [#D] 4.7 The Fate of Krelos (7.2) :plot_yes:
...
***** NEXT [#D] 6.2 - The Eternal Battle (7.3) :Sontarans:plot_yes:
...
***** NEXT [#A] 11.1 Blood of the Time Lords :Master_early:plot_yes:
...
**** LS7.2 Daleks! Genesis of Terror :Sarah:Harry:P2023_05:
*** BF misc :BigFinish:
...
**** NEXT [#D] CDNM3.2 The Tivolian Who Knew Too Much :Leela:plot_yes:1CD:
...
**** NEXT [#B] NA03 - The Romance of Crime (8.0) :Romana_2:2CD:scripted:
**** NEXT [#B] NA04 The English Way of Death :Romana_2:2CD:scripted:
