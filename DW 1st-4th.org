...
***** HALF [#C] EA1.4 - An Ordinary Life :Steven:Sara_Kingdom:plot_yes:DW2022_07_doctor:
...
***** [#A] 11.2 - Across the Darkened City
:PROPERTIES:
:rating:   8.5
:END:
...
**** [#C] +The Abominable Snowmen+ (7.5) :great_intelligence:missing:DW2022_08_extra:
...
**** TODO [#C] 6.1 Tales From the Vault :Ruth:UNIT:plot_yes:DW2022_08_doctor:
:PROPERTIES:
:rating:   7.5
:END:

**** READY [#C] 6.8 - The Selachian Gambit :Polly:Jamie:plot_yes:
...
**** TODO [#B] 8.X - The Last Day At Work
:PROPERTIES:
:rating:   8.1
:END:
...
**** READY [#C] ST7.X Landbound †7.6 :scripted:no_companion:
**** CANCEL [#E] 10.03 Decline of the Ancient Mariner †4.2 :Sarah:
CLOSED: [2020-06-25 Thu 21:52]

**** START [#A] ST11.3 The Threshold :Master_nemesis:P2022_02:DW2022_07_doctor:
SCHEDULED: <2022-07-16 Sat>
...
**** TODO [#C] 15x04 - The Sun Makers †7.8) :DW2022_08_extra:
