...
***** TODO [#B] 7.10 - The Library of Alexandria :plot_yes:DW2023_09_doctor:
:PROPERTIES:
:rating:   8.0
:END:
...
**** HALF [#C] LS2.1b The Fragile Yellow Arc of Fragrance :1CD:plot_yes:
*** short trips
...
***** NEXT [#B] CC8.12 - Second Chances :The_Company:plot_cast:
:PROPERTIES:
:rating:   8.4
:END:
...
***** NEXT [#D] 10.2 The Story of Extinction :Victoria:plot_no:
:PROPERTIES:
:rating:   7.2
:END:
...
***** NEXT [#B] CC12.4 - The Tactics of Defeat :Ruth:Zoe:UNIT:
:PROPERTIES:
:rating:   8.1
:END:
...
***** NEXT [#A] 14.3 The Prints of Denmark :Zoe:Monk:
...
**** TODO [#B] 8.2 The Devil's Hoofprints :P2021:Sarah:plot_yes:DW2023_09_doctor:
:PROPERTIES:
:rating:   8.1
:END:
...
***** HALF [#C] 4DA4.2 The Darkness of Glass :plot_yes:DW2023_08_doctor:
...
***** NEXT [#D] 4.7 The Fate of Krelos :plot_yes:
